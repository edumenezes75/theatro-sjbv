...
export default function SeloEvidencia({ status, label }: { status: string; label?: string }) {
  ...
  return (
    <span className="inline-flex items-center gap-1.5 font-sans text-xs font-medium uppercase tracking-[0.14em] text-ink/75 dark:text-cream/75" title={label || status}>
