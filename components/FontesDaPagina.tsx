...
export default function FontesDaPagina({ fontes }: { fontes: string | null }) {
  ...
  return (
    <details className="group mx-auto mt-16 max-w-reading border-t border-gold/30 pt-4">
      <summary className="cursor-pointer list-none font-sans text-xs uppercase tracking-eyebrow text-ink/70 transition-colors hover:text-curtain dark:text-cream/70 dark:hover:text-gold">
