    ...
    <footer className="mt-24 border-t border-gold/25 bg-ink text-cream dark:bg-black">
      <div className="mx-auto max-w-6xl px-5 py-16">
        ...
        <div className="mt-12 grid gap-10 sm:grid-cols-3">
          <div>
            <h3 className="font-sans text-[0.65rem] uppercase tracking-eyebrow text-gold">Visite</h3>
          ...
          <div>
            <h3 className="font-sans text-[0.65rem] uppercase tracking-eyebrow text-gold">Acervo & filme</h3>
            <ul className="mt-3 space-y-1.5 text-sm">
