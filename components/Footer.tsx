      ...
      <div className="mx-auto max-w-6xl px-5 py-16">
        ...
        <div className="mt-12 grid gap-10 sm:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-1.5 text-sm">
              {[['/acervo','Acervo de imagens'],['/documentario','Documentário Música & Drama'],['/linha-do-tempo','Linha do tempo'],['/episodios','Episódios'],['/memorias','Curiosidades'],['/livro-de-memorias','Livro de Memórias'],['/fontes','Pesquisa e fontes'],['/sobre','Sobre o projeto']].map(([h,l]) => (
                <li key={h}><Link href={h} className="text-cream/80 hover:text-gold">{l}</Link></li>
              ))}
            </ul>
          </div>
