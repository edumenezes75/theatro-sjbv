...
export type Foto = { id: string; file: string; category: string; categoryLabel: string; w: number; h: number; alt: string; credit: string; epoca?: string; rank?: number; cor?: boolean };
